 ...
 *
 * Purpose:   SSE implementation of frameshift null2 estimation from posterior
 *            probabilities (8-cell FS layout).
 *            See p7_Null2_fs_ByExpectation() documentation for details.
 *
 * Returns:   <eslOK> on success.
...
p7_Null2_fs_ByExpectation_sse(const P7_FS_OPROFILE *om_fs, P7_OMX *pp, float *null2)
{
  ...
  null2[om_fs->abc->K]    = 1.0;
  null2[om_fs->abc->Kp-2] = 1.0;
  null2[om_fs->abc->Kp-1] = 1.0;

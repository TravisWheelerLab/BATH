...
/* viterbi_sp.c */
extern int p7_Viterbi_SplicedGlobal(const ESL_DSQ *sub_dsq, const P7_FS_OPROFILE *om_fs, P7_OMX *ox, const float *signal_scores, int i_start, int i_end, int k_start, int k_end, int min_intron);

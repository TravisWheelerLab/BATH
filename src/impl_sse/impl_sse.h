...
extern int p7_SSVFilter_BATH(const ESL_DSQ *dsq, int L, uint32_t seq_id, uint8_t complementarity, P7_OPROFILE *om, P7_OMX *ox, const P7_SCOREDATA *msvdata, P7_BG *bg, double P, P7_HMM_WINDOWLIST *windowlist);

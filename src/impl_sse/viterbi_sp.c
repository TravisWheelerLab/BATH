                         ...
                         int min_intron)
{
  ...
  for (i = 3; i <= L; i++) {
    ...
    /* Second pass: P(i,k) acceptor-site lookup from accumulated donor scores.
     * Separated from the M/D/I loop so that loop's working set (dpc, dpp3, tfv)
     * is uncontaminated by OSS array accesses. Skipped entirely (~81% of rows)
     * when no acceptor signal is present. */
...
/*
   gcc -g -O3 -Wall -std=gnu99 -msse2 -o viterbi_sp_benchmark -I. -I.. -I../.. -I../../easel -I../../libdivsufsort -L.. -L../../easel -L../../libdivsufsort -Dp7VITERBI_SP_BENCHMARK viterbi_sp.c -lhmmer -leasel -ldivsufsort -lpthread -lm

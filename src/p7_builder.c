...
static int    calibrate            (P7_BUILDER *bld, P7_HMM *hmm, P7_BG *bg, P7_PROFILE **opt_gm, P7_OPROFILE **opt_om, P7_FS_PROFILE **opt_gm_fs5);
 ...
 *            opt_gm_fs5   - optRETURN: frameshift profile corresponding to <hmm>
...
p7_Builder(P7_BUILDER *bld, ESL_MSA *msa, P7_BG *bg,
	   P7_HMM **opt_hmm, P7_TRACE ***opt_trarr, P7_PROFILE **opt_gm, P7_OPROFILE **opt_om, P7_FS_PROFILE **opt_gm_fs5,
	   ESL_MSA **opt_postmsa)
{
  ...
  if ((status =  calibrate            (bld, hmm, bg, opt_gm, opt_om, opt_gm_fs5))   != eslOK) goto ERROR;
 ...
 */
static int
calibrate(P7_BUILDER *bld, P7_HMM *hmm, P7_BG *bg, P7_PROFILE **opt_gm, P7_OPROFILE **opt_om, P7_FS_PROFILE **opt_gm_fs5)
{
  int status;
  ...
  if ((status = p7_Calibrate(hmm, bld, &(bld->r), &bg, opt_gm, opt_om, opt_gm_fs5)) != eslOK) goto ERROR;
  return eslOK;

...
int
p7_splicevitebi_translated_semiglobal_trace2(SPLICE_PIPELINE *pli, const ESL_DSQ *sub_dsq, const ESL_GENCODE *gcode, const P7_FS_PROFILE *gm_fs, const P7_GMX *gx, P7_TRACE *tr, int i_start, int i_end, int k_start, int k_end, float *ali_score)
{
  int          M   = k_end - k_start + 1;
  int          L   = i_end - i_start + 1;
  int          i   = L;     /* position in seq (1..L)         */
